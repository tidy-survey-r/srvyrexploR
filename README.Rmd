...
The **srvyexploR** package provides datasets used in the book "Exploring Complex Survey Data Analysis in R: A Tidy Introduction with srvyr". This will help readers follow along with the examples and work through the exercises.
